...
@section('title') @lang('translation.Tenants') @endsection
                ...
                <div class="card-body">
                    <div class="row mb-2">
                        <h4 class="card-title col-sm-4">
                            @lang('translation.Tenants')
                        </h4>
                        <div class="col-sm-8">
                            <div class="text-sm-end">
                                <a href="{{route("tenant.detail", 0)}}"
                    ...
                    <table id="datatable"
                        ...
                        @foreach ($data as $item)
                            <tr class="text-center">
                                ...
                                <td>
                                    <a href="{{route("tenant.detail", $item->id)}}" class="text-success"><i
