                                    ...
                                    <td align="center" valign="top"
                                        ...
                                        <p class="text"
                                           style="color:#777777; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:12px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:20px; text-transform:none; text-align:center; padding:0; margin:0;">
                                            &copy;&nbsp;Table Visit . The Future of NightLife
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" valign="top"
                                        ...
                                        class="appLinks">
                                        <!-- App Links (Anroid)// -->
                                        <a href="https://tablevisit.com" target="_blank" style="display:inline-block;"
                                           class="play-store">
                                            <img src="{{ URL::asset('email-assets/play-store.png') }}" alt=""
                                                 width="120" border="0"
                                        ...
                                        <a href="https://tablevisit.com" target="_blank" style="display:inline-block;"
                                           class="app-store">
                                            <img src="{{ URL::asset('email-assets/app-store.png') }}" alt="" width="120"
                                                 border="0"
                                                 style="height:auto;margin:5px;width:100%;max-width:120px;"/>
                                        </a>
                                    </td>
