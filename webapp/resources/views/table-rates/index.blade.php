...
@section('title') @lang('translation.TableRates') @endsection
                ...
                <div class="card-body">
                    <div class="row mb-2">
                        <h4 class="card-title col-sm-4">
                            @lang('translation.TableRates')
                        </h4>
                        <div class="col-sm-8">
                            <div class="text-sm-end">
                                <a href="{{route("table-rate.detail", 0)}}"
                    ...
                    <table id="datatable"
                        ...
                        @foreach ($data as $item)
                            <tr class="text-center">
                                ...
                                <td>
                                    <a href="{{route("table-rate.delete", $item->id)}}"
                                       class="text-danger sweet-warning"><i
                                            class="mdi mdi-delete font-size-18"></i></a>
                                </td>
                                <td>
                                    <a href="{{route("table-rate.detail", $item->id)}}" class="text-success"><i
