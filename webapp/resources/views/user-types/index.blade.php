...
@section('content')
    ...
    @component('components.breadcrumb')
        ...
        @slot('title') @lang('translation.UserTypes') @endslot
    @endcomponent
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        <h4 class="card-title col-sm-4">
                            @lang('translation.UserTypes')
                        </h4>
                        <div class="col-sm-8">
                            <div class="text-sm-end">
                                <a href="{{route("user-type.detail", 0)}}"
                    ...
                    <table id="datatable"
                        ...
                        @foreach ($data as $item)
                            <tr class="text-center">
                                ...
                                <td>
                                    <a href="{{route("user-type.delete", $item->id)}}" class="text-danger"><i
                                            class="mdi mdi-delete font-size-18"></i></a>
                                </td>
                                <td>
                                    <a href="{{route("user-type.detail", $item->id)}}" class="text-success"><i
